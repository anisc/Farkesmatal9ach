...
dot = AssetLoader.dot;
    ...
    private void setBgOfButtons() {
        switch (type) {
            case 0:
                dot = AssetLoader.dot;
                break;
            case 1:
                dot = AssetLoader.dot2;
                break;
            case 2:
                dot = AssetLoader.dot3;
                break;
            case 3:
                dot = AssetLoader.dot4;
                break;
            case 4:
                dot = AssetLoader.dot5;
                break;

        }
        Sprite bgSprite = new Sprite(dot);
        bgSprite.setColor(FlatColors.DARK_BLACK);
        bgSprite.setPosition(getSprite().getX(), getSprite().getY());
        bgSprite.setSize(getSprite().getWidth(), getSprite().getHeight() - 10);
    ...
    public void render(SpriteBatch batch, ShapeRenderer shapeRenderer) {
        ...
        if (isPressed) {
            ...
            getSprite().setRegion(AssetLoader.button_down_sprites.get(this.type));
            getFlashSprite().setRegion(AssetLoader.button_down_sprites.get(this.type));
        } else {
            getSprite().setRegion(AssetLoader.button_up_sprites.get(this.type));
            getFlashSprite().setRegion(AssetLoader.button_up_sprites.get(this.type));
        }

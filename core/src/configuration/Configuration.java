...
public class Configuration {
    ...
    public static final String COLOR_BUTTON_3 = "#93E36F";
    public static final String COLOR_BUTTON_4 = "#FAEE67";
    public static final String COLOR_BUTTON_5 = "#B44BD5";
    ...
    public static final float START_TIMER = 100;
